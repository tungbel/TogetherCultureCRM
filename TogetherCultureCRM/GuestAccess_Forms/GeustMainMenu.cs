...
{
    // Main form for the geust access menu
    public partial class GeustMainMenu : Form
    {
        private readonly NavigationManager _navManager;

        // Constructor for initializing the form and setting default properties
        public GeustMainMenu()
        {
        ...
        // This method is called when the form has loaded; it opens the Dashboard form initially
        private void GeustMainMenu_Load(object sender, EventArgs e)
        {
            // Load the default child form (Dashboard) when the main menu loads
            _navManager.LoadDefaultChildForm(
                this,
                new Guest_Forms.Dashboard(),  // Default form to load
        ...
        private void btnDashboard_Click(object sender, EventArgs e)
        {
            ...
            _navManager.OpenChildForm(this, new Guest_Forms.Dashboard(), panelDisplay);
        }
        ...
        {
            _navManager.ActivateButton(sender, panelMenu, Color.FromArgb(222, 24, 96));
            _navManager.OpenChildForm(this, new Guest_Forms.Events(), panelDisplay);
        }

        // Button click event to open the Digital form
        private void btnDigitalContents_Click(object sender, EventArgs e)
        {
            _navManager.ActivateButton(sender, panelMenu, Color.FromArgb(222, 24, 96));
            _navManager.OpenChildForm(this, new Guest_Forms.Digital(), panelDisplay);
        }
