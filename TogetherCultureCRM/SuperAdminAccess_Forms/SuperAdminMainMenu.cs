...
namespace TogetherCultureCRM.SuperAdminAccess_Forms
{
    // Main form for the superadmin access menu
    public partial class SuperAdminMainMenu : Form
    {
        private readonly NavigationManager _navManager;
        // Fields for managing button state, form transition, and random values
        private Button currentButton; // Keeps track of the currently active button
        private Form activeForm; // Holds the current child form being displayed within the main menu

        // Constructor for initializing the form and setting default properties
        public SuperAdminMainMenu()
        {
            ...
            this.Load += SuperAdminMainMenu_Load;
        }
        ...
        //Methods
        private void SuperAdminMainMenu_Load(object sender, EventArgs e)
        {
            // Load the default child form (Dashboard) when the main menu loads
            _navManager.LoadDefaultChildForm(
                this,
                new SuperAdmin_Forms.Dashboard(),  // Default form to load
        ...
        private void btnDashboard_Click(object sender, EventArgs e)
        {
            ...
            _navManager.OpenChildForm(this, new SuperAdmin_Forms.Dashboard(), panelDisplay);
        }

        // Button click event to open the Admins form
        private void btnAdmins_Click(object sender, EventArgs e)
        {
            _navManager.ActivateButton(sender, panelMenu, Color.FromArgb(222, 24, 96));
            _navManager.OpenChildForm(this, new SuperAdmin_Forms.Admins(), panelDisplay);
        }
        ...
        {
            _navManager.ActivateButton(sender, panelMenu, Color.FromArgb(222, 24, 96));
            _navManager.OpenChildForm(this, new SuperAdmin_Forms.Events(), panelDisplay);
        }
        ...
        {
            _navManager.ActivateButton(sender, panelMenu, Color.FromArgb(222, 24, 96));
            _navManager.OpenChildForm(this, new SuperAdmin_Forms.Reports(), panelDisplay);
        }
        ...
        // Minimize/Restore button click event to toggle window state
